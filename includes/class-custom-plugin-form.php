...
class Form
{
    ...
    public function __construct()
    {
        ...
        add_shortcode('custom_plugin', array($this, 'render_form'));

        // Handle form submission.
        add_action('init', array($this, 'handle_custom_plugin'));
    }
    ...
    {
        return apply_filters('custom_plugin_fields', array(
     ...
     */
    public function handle_custom_plugin()
    {
        // Check if form is submitted
        if (isset($_POST['custom_plugin_nonce'])) {

            // Verify nonce for security.
            if (! isset($_POST['custom_plugin_nonce']) || ! wp_verify_nonce($_POST['custom_plugin_nonce'], 'custom_plugin_action')) {
                wp_die(esc_html__('Security check failed.', 'custom_plugin'));
            }
            ...
            // Save each submitted value as post meta.
